...
CFLAGS=-Wall 
LDFLAGS=-lMLV -lm -g
REPOBJ=bin/main.o bin/window.o bin/key_listener.o bin/player_controller.o bin/enemies_controller.o bin/game.o bin/powerup.o
OBJ=main.o window.o key_listener.o player_controller.o enemies_controller.o game.o powerup.o
MAIN=main
BIN=bin/
...
main.o: src/main.c src/include/window.h src/include/key_listener.h src/include/player_controller.h src/include/enemies_controller.h src/include/game.h src/include/powerup.h
...
player_controller.o: src/include/window.h
	$(CC) -c src/controller/player_controller.c $(CFLAGS) -o $(BIN)$@

enemies_controller.o: src/include/key_listener.h src/include/player_controller.h src/include/window.h src/include/game.h
...
powerup.o: src/include/key_listener.h src/include/player_controller.h src/include/enemies_controller.h src/include/window.h
